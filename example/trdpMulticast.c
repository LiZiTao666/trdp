...
static void process_data()
{
    ...
    EGWM_TO_EDCU sendData;

    sendData.terminalActive = 0x80;                    //TC1,TC2未占有
    sendData.centralDoorSign = 0x41;                   //集控开右门,限电模式开;
    sendData.delayTimeHBeforeClosing = 0x00;        //门关闭延时时间 
	sendData.delayTimeLBeforeClosing = 0x14;        // 20*0.1 = 2s
    sendData.closingAttemptsHAfterObstructionDetectionInClosingSequence = 0x00;    //关闭过程中障碍物探测的关闭次数 H
	sendData.closingAttemptsLAfterObstructionDetectionInClosingSequence = 0x03;    //关闭过程中障碍物探测的关闭次数 L
	
    data[0] = sendData.terminalActive;
    data[1] = sendData.centralDoorSign;
    data[2] = sendData.delayTimeHBeforeClosing;
    data[3] = sendData.delayTimeLBeforeClosing;
    data[4] = sendData.closingAttemptsHAfterObstructionDetectionInClosingSequence;
    data[5] = sendData.closingAttemptsLAfterObstructionDetectionInClosingSequence;
